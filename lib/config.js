...
const value = {
  ...
  cache: {
    ...
    type: envs.CACHE_TYPE === undefined ? "memory" : envs.CACHE_TYPE.toLowerCase(),
    // 路由缓存时间，单位为秒
  ...
  ua:
    envs.UA || "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/65.0.3325.181 Safari/537.36",
