...
const calculateValue = () => {
    ...
    value = {
        ...
        cache: {
            ...
            type: typeof envs.CACHE_TYPE === 'undefined' ? 'memory' : envs.CACHE_TYPE,
            // 路由缓存时间，单位为秒
            routeExpire: parseInt(envs.CACHE_EXPIRE) || 1 * 60,
            // 不变内容缓存时间，单位为秒
            contentExpire: parseInt(envs.CACHE_CONTENT_EXPIRE) || 15 * 24 * 60 * 60,
        },
