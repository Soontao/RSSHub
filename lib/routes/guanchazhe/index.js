        ...
        items = await Promise.all(
            links.map((itemLink) =>
                ctx.cache.tryGet(itemLink, async () => {
                    ...
                    const title = $item('body > div.content > div.main.content-main > ul > li.left.left-main > h3').text();
                    const description = $item('body > div.content > div.main.content-main > ul > li.left.left-main > div.content.all-txt').html().trim();
