...
const map = new Map([
  ...
  [
    "3",
    { name: "交易策略", link: "strategy", category: "weex-tradingstrategies" },
  ],
  [
    "4",
    { name: "机构观点", link: "opinion", category: "weex-institutioncomments" },
  ],
  ["5", { name: "投资学堂", link: "education", category: "weex-introduction" }],
  [
    "6",
    { name: "行业观察", link: "industry", category: "weex-industryanalysis" },
  ],
