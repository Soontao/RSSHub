...
const apiUrl =
  "https://apps.game.qq.com/cmc/zmMcnTargetContentList?r0=jsonp&page=1&num=16&target=";
module.exports = async (ctx) => {
  ...
  if (type === "all") {
    ...
    ctx.state.data = {
      ...
      description:
        "英雄联盟官方网站，海量风格各异的英雄，丰富、便捷的物品合成系统，游戏内置的匹配、排行和竞技系统，独创的“召唤师”系统及技能、符文、天赋等系统组合，必将带你进入一个崭新而又丰富多彩的游戏世界。",
      item: items,
    };
  } else {
