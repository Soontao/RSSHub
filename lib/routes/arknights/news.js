...
module.exports = async (ctx) => {
    ...
    const newslist = $("div.articleContainer.articleContainer > div.articleListWrapper li.articleItem").slice(0, 10);
        ...
        newslist
            .map(async (index, item) => {
                ...
                return await ctx.cache.tryGet(link, async () => {
                    ...
                    const pubDate = moment($(".article-date").text().slice(8), "YYYY-MM-DD").toDate();
