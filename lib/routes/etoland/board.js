...
module.exports = async (ctx) => {
  ...
  const list = $('form[name="fboardlist"]>table tr[align="center"]').filter(
    (index, item) => {
      item = $(item);
