...
module.exports = async (ctx) => {
  ...
  const api =
    "https://home.kpmg/search/?all_sites=false&site=cn_zh&language=zh&x1=KPMG_Tab_Type&q1=Insights&sort=KPMG_Filter_Date&facets=false";
  ...
  ctx.state.data = {
    ...
    link: link,
    description:
      "欢迎浏览毕马威中国网站的知识库。在这里，你可以找到毕马威中国各类定期出版的通讯及各通讯过往的期号。",
    item: out,
  };
};
