...
module.exports = async (ctx) => {
  ...
  if (category === "news") {
    categoryName = "総合";
    list = $("div.k-card.k-card--small.k-card--reverse,.k-card--headline")
      .not('[data-rn-track="hub-ad-recommend"]')
      .not(".k-hub-card--small-title");
      ...
      .map(async (index, item) => {
        ...
        if (memberLimit && article_type === "free") {
          ...
          const description = await ctx.cache.tryGet(link, async () => {
            ...
            return $(
              "div.cmn-article_text.a-cf.JSID_key_fonttxt.m-streamer_medium",
            ).html();
          });
