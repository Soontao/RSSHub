...
module.exports = async (ctx) => {
  ...
  const url_detail =
    "https://xd.newrank.cn/xdnphb/nr/cloud/douyin/detail/aweme?xyz=" +
    utils.decrypt_douyin_detail_xyz(nonce) +
    "&nonce=" +
    nonce;
  ...
  const url_account =
    "https://xd.newrank.cn/xdnphb/nr/cloud/douyin/detail/accountInfoAll?nonce=" +
    nonce +
    "&xyz=" +
    utils.decrypt_douyin_account_xyz(nonce);
