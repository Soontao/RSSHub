  ...
  const out = await Promise.all(
    list
      .map(async (index, item) => {
        ...
        let author;
        let title =
          item.find(".tgme_widget_message_text > a:nth-child(5)").text() ||
          item.find(".tgme_widget_message_text > a:nth-child(2)").text();
        ...
        const link =
          item
          	.find(".tgme_widget_message_text > a:nth-child(5)")
          	.attr("href") ||
          item.find(".tgme_widget_message_text > a:nth-child(2)").attr("href");
