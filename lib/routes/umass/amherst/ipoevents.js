  ...
  ctx.state.data = {
    ...
    item:
      ...
      list
        .map((index, item) => {
          item = $(item);
          const eventDateTxt = item
            .find(".views-field-field-event-date .date-display-single")
            .first();
          const eventStartDateTxt = item
            .find(
              ".views-field-field-event-date .date-display-single .date-display-start",
            )
            .first()
            .attr("content");
