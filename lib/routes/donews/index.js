...
module.exports = async (ctx) => {
  ...
  case "":
    ...
    list = list.concat(
      $(".fl.w840 > .block > dl > dd > h3 > a").slice(0, 7).get(),
    );
  ...
  case "idonews":
    ...
    list = list.concat(
      $(".fl.w840 > .block > dl > dd > h3 > a").slice(0, 5).get(),
    );
  ...
  ctx.state.data = {
    ...
    link: host,
    description:
      "中国最早的web2.0网站，专业科技媒体、互联网行业门户网站。提供互联网新闻IT资讯，关注科技创新，覆盖移动互联网创业、游戏、风险投资等热点，是中国互联网行业的风向标。",
    item: items,
  };
};
