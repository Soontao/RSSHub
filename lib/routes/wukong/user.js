  ...
  const list = data.map((item) => {
    ...
    case "dongtai": {
      ...
      return {
        ...
        link: isQuestion
          ? `https://www.wukong.com/question/${item.dongtai_cell.dongtai.base.question.qid}`
          : `https://www.wukong.com/answer/${item.dongtai_cell.dongtai.base.answer.ansid}`,
        description: isQuestion
          ? item.dongtai_cell.dongtai.base.question.content.text
          : item.dongtai_cell.dongtai.base.answer.content,
        pubDate: new Date(
          (isQuestion
            ? item.dongtai_cell.dongtai.base.question.create_time
            : item.dongtai_cell.dongtai.base.answer.create_time) * 1000,
        ).toUTCString(),
      };
    }
    case "answers": {
