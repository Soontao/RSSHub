...
const preCache = require('./middleware/pre-cache');
...
if (typeof process.env.MEILLI_SEARCH_URL === 'string') {
    logger.info('rss will be pushed to meillisearch', process.env.MEILLI_SEARCH_URL);
    app.use(require('./middleware/meillisearch'));
}
