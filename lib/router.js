...
router.get(
  "/",
  lazyRouter(() => nativeRequire("./routes/index")),
);
...
router.get(
  "/quicker/user/action/:uid/:person",
  require("./routes/quicker/person.js"),
);
...
router.get(
  ...
  require("./routes/bilibili/video"),
);
router.get("/bilibili/user/article/:uid", require("./routes/bilibili/article"));
router.get(
  "/bilibili/user/fav/:uid/:disableEmbed?",
  require("./routes/bilibili/userFav"),
);
router.get(
  "/bilibili/user/coin/:uid/:disableEmbed?",
  require("./routes/bilibili/coin"),
);
router.get(
  "/bilibili/user/dynamic/:uid/:disableEmbed?",
  require("./routes/bilibili/dynamic"),
);
router.get(
...
router.get(
  ...
  require("./routes/bilibili/user_bangumi"),
);
router.get(
  "/bilibili/partion/:tid/:disableEmbed?",
  require("./routes/bilibili/partion"),
);
router.get(
  "/bilibili/partion/ranking/:tid/:days?/:disableEmbed?",
  require("./routes/bilibili/partion-ranking"),
);
router.get("/bilibili/bangumi/:seasonid", require("./routes/bilibili/bangumi")); // 弃用
router.get(
  "/bilibili/bangumi/media/:mediaid",
  require("./routes/bilibili/bangumi"),
);
router.get(
  "/bilibili/video/page/:bvid/:disableEmbed?",
  require("./routes/bilibili/page"),
);
router.get("/bilibili/video/reply/:bvid", require("./routes/bilibili/reply"));
router.get(
  "/bilibili/video/danmaku/:bvid/:pid?",
  require("./routes/bilibili/danmaku"),
);
router.get(
...
router.get(
  "/bilibili/fav/:uid/:fid/:disableEmbed?",
  require("./routes/bilibili/fav"),
);
router.get("/bilibili/blackboard", require("./routes/bilibili/blackboard"));
router.get(
  "/bilibili/mall/new/:category?",
  require("./routes/bilibili/mallNew"),
);
router.get("/bilibili/mall/ip/:id", require("./routes/bilibili/mallIP"));
router.get(
  "/bilibili/ranking/:rid?/:day?/:arc_type?/:disableEmbed?",
  require("./routes/bilibili/ranking"),
);
router.get(
  "/bilibili/user/channel/:uid/:cid/:disableEmbed?",
  require("./routes/bilibili/userChannel"),
);
router.get("/bilibili/topic/:topic", require("./routes/bilibili/topic"));
router.get("/bilibili/audio/:id", require("./routes/bilibili/audio"));
router.get(
  "/bilibili/vsearch/:kw/:order?/:disableEmbed?",
  require("./routes/bilibili/vsearch"),
);
router.get(
  "/bilibili/followings/video/:uid/:disableEmbed?",
  require("./routes/bilibili/followings_video"),
);
router.get(
  "/bilibili/followings/article/:uid",
  require("./routes/bilibili/followings_article"),
);
...
router.get(
  ...
  require("./routes/bilibili/manga_update"),
);

// bangumi
router.get(
  "/bangumi/calendar/today",
  require("./routes/bangumi/calendar/today"),
);
...
router.get(
  ...
  require("./routes/juejin/trending"),
);
...
router.get(
  ...
  require("./routes/juejin/collection"),
);
...
router.get(
  "/jianshu/trending/:timeframe",
  require("./routes/jianshu/trending"),
);
...
router.get(
  ...
  require("./routes/zhihu/daily_section"),
);
...
router.get(
  ...
  require("./routes/zhihu/bookstore/newest"),
);
...
router.get(
  "/pixiv/search/:keyword/:order?/:r18?",
  require("./routes/pixiv/search"),
);
...
router.get(
  ...
  require("./routes/douban/classification.js"),
);
...
router.get(
  ...
  require("./routes/douban/explore_column"),
);
router.get(
  "/douban/people/:userid/status",
  require("./routes/douban/people/status.js"),
);
...
router.get(
  ...
  require("./routes/douban/channel/topic.js"),
);
router.get(
  "/douban/channel/:id/subject/:nav",
  require("./routes/douban/channel/subject.js"),
);
router.get(
  "/douban/celebrity/:id/:sort?",
  require("./routes/douban/celebrity.js"),
);
...
router.get(
  ...
  require("./routes/jinritoutiao/keyword"),
);
...
router.get(
  ...
  require("./routes/youtube/playlist"),
);
...
router.get(
  ...
  require("./routes/dribbble/popular"),
);
...
router.get(
  ...
  require("./routes/telegram/channel"),
);
router.get(
  "/telegram/stickerpack/:name",
  require("./routes/telegram/stickerpack"),
);
...
router.get(
  ...
  require("./routes/konachan/post_popular_recent"),
);
router.get(
  "/konachan.com/post/popular_recent",
  require("./routes/konachan/post_popular_recent"),
);
router.get(
  "/konachan.net/post/popular_recent",
  require("./routes/konachan/post_popular_recent"),
);
router.get(
...
router.get(
  "/konachan.com/post/popular_recent/:period",
  require("./routes/konachan/post_popular_recent"),
);
router.get(
  "/konachan.net/post/popular_recent/:period",
  require("./routes/konachan/post_popular_recent"),
);
...
router.get(
  "/pornhub/category_url/:url?",
  require("./routes/pornhub/category_url"),
);
router.get("/pornhub/users/:username", require("./routes/pornhub/users"));
router.get(
  "/pornhub/model/:username/:sort?",
  require("./routes/pornhub/model"),
);
router.get(
  "/pornhub/pornstar/:username/:sort?",
  require("./routes/pornhub/pornstar"),
);

// yande.re
router.get(
  "/yande.re/post/popular_recent",
  require("./routes/yande.re/post_popular_recent"),
);
router.get(
...
router.get(
  ...
  require("./routes/mi/youpin/crowdfunding"),
);
...
router.get(
  ...
  require("./routes/dongqiudi/team_news"),
);
router.get(
  "/dongqiudi/player_news/:id",
  require("./routes/dongqiudi/player_news"),
);
...
router.get(
  ...
  require("./routes/xuangubao/subject"),
);
...
router.get(
  ...
  require("./routes/xueqiu/stock_info"),
);
...
router.get(
  ...
  require("./routes/greasyfork/scripts"),
);
...
// 腾讯游戏开发者社区
router.get(
  "/gameinstitute/community/:tag?",
  require("./routes/tencent/gameinstitute/community"),
);

// 腾讯视频 SDK
router.get(
  "/qcloud/mlvb/changelog",
  require("./routes/tencent/qcloud/mlvb/changelog"),
);

// 腾讯吐个槽
router.get(
  "/tucaoqq/post/:project/:key",
  require("./routes/tencent/tucaoqq/post"),
);

// Bugly SDK
router.get(
  "/bugly/changelog/:platform",
  require("./routes/tencent/bugly/changelog"),
);
...
router.get(
  ...
  require("./routes/tencent/wechat/miniprogram/plugins"),
);
router.get(
  "/wechat/tgchannel/:id",
  require("./routes/tencent/wechat/tgchannel"),
);
router.get("/wechat/uread/:userid", require("./routes/tencent/wechat/uread"));
router.get(
  "/wechat/ershicimi/:id",
  require("./routes/tencent/wechat/ershcimi"),
);
router.get("/wechat/wjdn/:id", require("./routes/tencent/wechat/wjdn"));
router.get(
  "/wechat/mp/homepage/:biz/:hid/:cid?",
  require("./routes/tencent/wechat/mp"),
);
router.get(
  "/wechat/mp/msgalbum/:biz/:aid",
  require("./routes/tencent/wechat/msgalbum"),
);
...
router.get(
  ...
  require("./routes/nvidia/webdriverupdate"),
);
...
// AppStore
router.get(
  "/appstore/update/:country/:id",
  require("./routes/apple/appstore/update"),
);
router.get(
  "/appstore/price/:country/:type/:id",
  require("./routes/apple/appstore/price"),
);
router.get(
  "/appstore/iap/:country/:id",
  require("./routes/apple/appstore/in-app-purchase"),
);
...
router.get(
  "/novel/biqugeinfo/:id/:limit?",
  require("./routes/novel/biqugeinfo"),
);
...
router.get(
  "/bjfu/news/:type",
  require("./routes/universities/bjfu/news/index"),
);
...
// 大连工业大学
router.get(
  "/dpu/jiaowu/news/:type?",
  require("./routes/universities/dpu/jiaowu/news"),
);
router.get(
  "/dpu/wlfw/news/:type?",
  require("./routes/universities/dpu/wlfw/news"),
);

// 东南大学
router.get(
  "/seu/radio/academic",
  require("./routes/universities/seu/radio/academic"),
);
...
router.get(
  "/nuaa/yjsy/:type?",
  require("./routes/universities/nuaa/yjsy/yjsy"),
);
...
router.get(
  ...
  require("./routes/universities/shanghaitech/activity"),
);
router.get(
  "/shanghaitech/sist/activity",
  require("./routes/universities/shanghaitech/sist/activity"),
);

// 上海交通大学
router.get(
  "/sjtu/seiee/academic",
  require("./routes/universities/sjtu/seiee/academic"),
);
router.get(
  "/sjtu/seiee/bjwb/:type",
  require("./routes/universities/sjtu/seiee/bjwb"),
);
router.get(
  "/sjtu/seiee/xsb/:type?",
  require("./routes/universities/sjtu/seiee/xsb"),
);

router.get(
  "/sjtu/gs/tzgg/:type?",
  require("./routes/universities/sjtu/gs/tzgg"),
);
router.get("/sjtu/jwc/:type?", require("./routes/universities/sjtu/jwc"));
router.get(
  "/sjtu/tongqu/:type?",
  require("./routes/universities/sjtu/tongqu/activity"),
);
router.get(
  "/sjtu/yzb/zkxx/:type",
  require("./routes/universities/sjtu/yzb/zkxx"),
);
...
router.get(
  "/pku/cls/lecture",
  require("./routes/universities/pku/cls/lecture"),
);
...
router.get(
  "/swust/jwc/notice/:type?",
  require("./routes/universities/swust/jwc_notice"),
);
...
router.get(
  "/cas/sim/academic",
  require("./routes/universities/cas/sim/academic"),
);
...
// 哈尔滨工程大学
router.get(
  "/heu/ugs/news/:author?/:category?",
  require("./routes/universities/heu/ugs/news"),
);
...
router.get(
  ...
  require("./routes/universities/cqu/jwc/announcement"),
);
...
router.get(
  "/cqu/youth/:category",
  require("./routes/universities/cqu/youth/info"),
);
...
router.get(
  ...
  require("./routes/universities/nuist/bulletin"),
);
...
router.get(
  "/nuist/sese/:category?",
  require("./routes/universities/nuist/sese"),
);
...
router.get(
  "/zzu/soft/news/:type",
  require("./routes/universities/zzu/soft/news"),
);

// 郑州轻工业大学
router.get(
  "/zzuli/campus/:type",
  require("./routes/universities/zzuli/campus"),
);
...
router.get(
  "/njust/eo/:grade?/:type?",
  require("./routes/universities/njust/eo"),
);

// 四川旅游学院
router.get(
  "/sctu/xgxy",
  require("./routes/universities/sctu/information-engineer-faculty/index"),
);
router.get(
  "/sctu/xgxy/:id",
  require("./routes/universities/sctu/information-engineer-faculty/context"),
);
router.get("/sctu/jwc/:type?", require("./routes/universities/sctu/jwc/index"));
router.get(
  "/sctu/jwc/:type/:id",
  require("./routes/universities/sctu/jwc/context"),
);
...
router.get(
  ...
  require("./routes/universities/ynu/grs/qttz"),
);
...
router.get(
  ...
  require("./routes/universities/kmust/job/careers"),
);
router.get(
  "/kmust/job/jobfairs",
  require("./routes/universities/kmust/job/jobfairs"),
);
...
router.get(
  ...
  require("./routes/universities/hust/aia/notice"),
);
...
router.get(
  "/dlu/jiaowu/news",
  require("./routes/universities/dlu/jiaowu/news"),
);
...
router.get(
  ...
  require("./routes/universities/scut/jwc/notice"),
);
...
router.get(
  "/buaa/news/:type",
  require("./routes/universities/buaa/news/index"),
);
...
router.get(
  "/ustb/tj/news/:type?",
  require("./routes/universities/ustb/tj/news"),
);
...
router.get(
  "/ahau/cs_news/:type",
  require("./routes/universities/ahau/cs_news/index"),
);
router.get("/ahau/jwc/:type", require("./routes/universities/ahau/jwc/index"));
router.get(
  "/ahau/main/:type",
  require("./routes/universities/ahau/main/index"),
);
...
router.get(
  ...
  require("./routes/apple/exchange_repair"),
);
...
router.get(
  "/thepaper/839studio",
  require("./routes/thepaper/839studio/studio.js"),
);
router.get(
  "/thepaper/839studio/:id",
  require("./routes/thepaper/839studio/category.js"),
);
...
router.get(
  "/60s-science/transcript",
  require("./routes/60s-science/transcript"),
);

// 99% Invisible
router.get(
  "/99percentinvisible/transcript",
  require("./routes/99percentinvisible/transcript"),
);
...
router.get(
  ...
  require("./routes/dgtle/whale_rank"),
);
...
router.get(
  "/xidian/jwc/:category?",
  require("./routes/universities/xidian/jwc"),
);
...
// GitChat
router.get(
  "/gitchat/newest/:category?/:selected?",
  require("./routes/gitchat/newest"),
);
...
// 下厨房
router.get(
  "/xiachufang/user/cooked/:id",
  require("./routes/xiachufang/user/cooked"),
);
router.get(
  "/xiachufang/user/created/:id",
  require("./routes/xiachufang/user/created"),
);
router.get(
  "/xiachufang/popular/:timeframe?",
  require("./routes/xiachufang/popular"),
);
...
// 腾讯视频
router.get(
  "/tencentvideo/playlist/:id",
  require("./routes/tencent/video/playlist"),
);
...
router.get(
  ...
  require("./routes/dongmanmanhua/comic"),
);
// webtoons
router.get(
  "/webtoons/:lang/:category/:name/:id",
  require("./routes/webtoons/comic"),
);
...
router.get(
  "/typora/changelog-dev/:os?",
  require("./routes/typora/changelog-dev"),
);
...
router.get(
  ...
  require("./routes/javbus/uncensored/home"),
);
router.get(
  "/javbus/uncensored/genre/:gid",
  require("./routes/javbus/uncensored/genre"),
);
router.get(
  "/javbus/uncensored/star/:sid",
  require("./routes/javbus/uncensored/star"),
);
router.get(
  "/javbus/uncensored/series/:seriesid",
  require("./routes/javbus/uncensored/series"),
);
router.get("/javbus/western/home", require("./routes/javbus/western/home"));
router.get(
  "/javbus/western/genre/:gid",
  require("./routes/javbus/western/genre"),
);
router.get(
  "/javbus/western/star/:sid",
  require("./routes/javbus/western/star"),
);
router.get(
  "/javbus/western/series/:seriesid",
  require("./routes/javbus/western/series"),
);
...
// Apkpure
router.get(
  "/apkpure/versions/:region/:pkg",
  require("./routes/apkpure/versions"),
);
...
// Steamgifts
router.get(
  "/steamgifts/discussions/:category?",
  require("./routes/steam/steamgifts/discussions"),
);

// 扇贝
router.get("/shanbay/checkin/:id", require("./routes/shanbay/checkin"));
router.get(
  "/shanbay/footprints/:category?",
  require("./routes/shanbay/footprints"),
);
...
router.get(
  ...
  require("./routes/36kr/search/article"),
);
...
router.get(
  ...
  require("./routes/patchwork.kernel.org/comments"),
);

// 京东众筹
router.get(
  "/jingdong/zhongchou/:type/:status/:sort",
  require("./routes/jingdong/zhongchou"),
);
...
router.get(
  "/wallstreetcn/live/:channel?",
  require("./routes/wallstreetcn/live"),
);
...
router.get(
  ...
  require("./routes/gov/zhengce/wenjian"),
);
router.get(
  "/gov/zhengce/govall/:advance?",
  require("./routes/gov/zhengce/govall"),
);
...
router.get(
  ...
  require("./routes/gov/statecouncil/briefing"),
);
...
// 国家新闻出版广电总局
router.get(
  "/gov/sapprft/approval/:channel/:detail?",
  require("./routes/gov/sapprft/7026"),
);

// 国家新闻出版署
router.get("/gov/nppa/:channel", require("./routes/gov/nppa/channels"));
router.get(
  "/gov/nppa/:channel/:content",
  require("./routes/gov/nppa/contents"),
);
...
router.get(
  ...
  require("./routes/xiaoheihe/discount"),
);
...
router.get(
  ...
  require("./routes/dockerhub/build"),
);
...
router.get(
  ...
  require("./routes/woshipm/user_article"),
);
...
router.get(
  ...
  require("./routes/whalegogo/portal"),
);

// 爱思想
router.get("/aisixiang/column/:id", require("./routes/aisixiang/column"));
router.get(
  "/aisixiang/ranking/:type?/:range?",
  require("./routes/aisixiang/ranking"),
);
router.get(
  "/aisixiang/thinktank/:name/:type?",
  require("./routes/aisixiang/thinktank"),
);
...
router.get(
  "/leetcode/submission/us/:user",
  require("./routes/leetcode/check-us"),
);
router.get(
  "/leetcode/submission/cn/:user",
  require("./routes/leetcode/check-cn"),
);

// segmentfault
router.get(
  "/segmentfault/channel/:name",
  require("./routes/segmentfault/channel"),
);
...
// WordPress
router.get(
  "/blogs/wordpress/:domain/:https?",
  require("./routes/blogs/wordpress"),
);
...
router.get(
  "/uraaka-joshi/:id",
  require("./routes/uraaka-joshi/uraaka-joshi-user"),
);
...
router.get(
  "/zju/cst/custom/:id",
  require("./routes/universities/zju/cst/custom"),
);

// 浙江大学城市学院
router.get("/zucc/news/latest", require("./routes/universities/zucc/news"));
router.get(
  "/zucc/cssearch/latest/:webVpn/:key",
  require("./routes/universities/zucc/cssearch"),
);
...
// 谷雨
router.get(
  "/tencent/guyu/channel/:name",
  require("./routes/tencent/guyu/channel"),
);

// 古诗文网
router.get(
  "/gushiwen/recommend/:annotation?",
  require("./routes/gushiwen/recommend"),
);
...
router.get(
  ...
  require("./routes/1point3acres/threads"),
);
router.get(
  "/1point3acres/user/:id/posts",
  require("./routes/1point3acres/posts"),
);
router.get(
  "/1point3acres/offer/:year?/:major?/:school?",
  require("./routes/1point3acres/offer"),
);
router.get(
  "/1point3acres/post/:category",
  require("./routes/1point3acres/post"),
);
...
router.get(
  ...
  require("./routes/quantamagazine/archive"),
);
...
router.get(
  ...
  require("./routes/nintendo/system-update"),
);
...
router.get(
  ...
  require("./routes/universities/mit/graduateadmissions"),
);
...
router.get(
  ...
  require("./routes/the-economist/gre-vocabulary"),
);
...
// 朝日新聞中文网（简体中文版）
router.get(
  "/asahichinese-j/:category/:subCate",
  require("./routes/asahichinese-j/index"),
);
router.get(
  "/asahichinese-j/:category",
  require("./routes/asahichinese-j/index"),
);

// 朝日新聞中文網（繁體中文版）
router.get(
  "/asahichinese-f/:category/:subCate",
  require("./routes/asahichinese-f/index"),
);
router.get(
  "/asahichinese-f/:category",
  require("./routes/asahichinese-f/index"),
);
...
router.get(
  "/zfrontier/board/:boardId",
  require("./routes/zfrontier/board_postlist"),
);

// 观察者风闻话题
router.get("/guanchazhe/topic/:id", require("./routes/guanchazhe/topic"));
router.get(
  "/guanchazhe/personalpage/:uid",
  require("./routes/guanchazhe/personalpage"),
);
...
// 通用CurseForge
router.get(
  "/curseforge/:gameid/:catagoryid/:projectid/files",
  require("./routes/curseforge/generalfiles"),
);
...
// 飞地
router.get(
  "/enclavebooks/category/:id?",
  require("./routes/enclavebooks/category"),
);
router.get("/enclavebooks/user/:uid", require("./routes/enclavebooks/user.js"));
router.get(
  "/enclavebooks/collection/:uid",
  require("./routes/enclavebooks/collection.js"),
);

// 色花堂
router.get(
  "/dsndsht23/picture/:subforumid",
  require("./routes/dsndsht23/index"),
);
router.get("/dsndsht23/bt/:subforumid?", require("./routes/dsndsht23/index"));
router.get(
  "/dsndsht23/:subforumid?/:type?",
  require("./routes/dsndsht23/index"),
);
...
router.get(
  ...
  require("./routes/digitaling/article"),
);

// 数英网项目专题
router.get(
  "/digitaling/projects/:category",
  require("./routes/digitaling/project"),
);
...
// Metacritic
router.get(
  "/metacritic/release/:platform/:type/:sort?",
  require("./routes/metacritic/release"),
);
...
router.get(
  ...
  require("./routes/outagereport/service"),
);
...
router.get(
  "/flyertea/creditcard/:bank",
  require("./routes/flyertea/creditcard"),
);
...
router.get(
  ...
  require("./routes/cninfo/announcement"),
);
router.get(
  "/cninfo/stock_announcement/:code",
  require("./routes/cninfo/stock_announcement"),
);
router.get(
  "/cninfo/fund_announcement/:code?/:searchkey?",
  require("./routes/cninfo/fund_announcement"),
);
...
router.get(
  ...
  require("./routes/simonsfoundation/articles"),
);
router.get(
  "/simonsfoundation/recommend",
  require("./routes/simonsfoundation/recommend"),
);

// 王者荣耀
router.get(
  "/tencent/pvp/newsindex/:type",
  require("./routes/tencent/pvp/newsindex"),
);
...
// 学堂在线
router.get(
  "/xuetangx/course/:cid/:type",
  require("./routes/xuetangx/course_info"),
);
router.get(
  "/xuetangx/course/list/:mode/:credential/:status/:type?",
  require("./routes/xuetangx/course_list"),
);

// wikihow
router.get("/wikihow/index", require("./routes/wikihow/index.js"));
router.get(
  "/wikihow/category/:category/:type",
  require("./routes/wikihow/category.js"),
);

// 正版中国
router.get(
  "/getitfree/category/:category?",
  require("./routes/getitfree/category.js"),
);
router.get(
  "/getitfree/search/:keyword?",
  require("./routes/getitfree/search.js"),
);
...
router.get(
  ...
  require("./routes/coolapk/userDynamic"),
);
...
router.get(
  "/dlmu/grs/zsgz/:type",
  require("./routes/universities/dlmu/grs/zsgz"),
);
...
router.get(
  "/ctfhub/calendar/:limit?/:form?/:class?/:title?",
  require("./routes/ctfhub"),
);
...
router.get(
  ...
  require("./routes/aliyun/developer/group"),
);
...
// 中国日报
router.get(
  "/chinadaily/english/:category",
  require("./routes/chinadaily/english.js"),
);
...
router.get(
  "/eleme/open-be/announce",
  require("./routes/eleme/open-be/announce"),
);

// 微信开放社区
router.get(
  "/wechat-open/community/:type",
  require("./routes/tencent/wechat/wechat-open/community/announce"),
);
// 微信支付 - 商户平台公告
router.get(
  "/wechat-open/pay/announce",
  require("./routes/tencent/wechat/wechat-open/pay/announce"),
);
router.get(
  "/wechat-open/community/:type/:category",
  require("./routes/tencent/wechat/wechat-open/community/question"),
);
...
router.get(
  ...
  require("./routes/tencent/news/author"),
);
...
// 路透社
router.get(
  "/reuters/channel/:site/:channel",
  require("./routes/reuters/channel"),
);
...
// 微博个人时间线
router.get(
  "/weibo/timeline/:uid/:feature?",
  require("./routes/weibo/timeline"),
);
...
// 米坛社区表盘
router.get(
  "/watchface/:watch_type?/:list_type?",
  require("./routes/watchface/update"),
);

// CNU视觉联盟
router.get("/cnu/selected", require("./routes/cnu/selected"));
router.get(
  "/cnu/discovery/:type?/:category?",
  require("./routes/cnu/discovery"),
);
...
router.get(
  ...
  require("./routes/xiaohongshu/user"),
);
router.get(
  "/xiaohongshu/board/:board_id",
  require("./routes/xiaohongshu/board"),
);
...
router.get(
  ...
  require("./routes/zhishifenzi/innovation"),
);
...
// はてな匿名ダイアリー
router.get(
  "/hatena/anonymous_diary/archive",
  require("./routes/hatena/anonymous_diary/archive"),
);

// kaggle
router.get(
  "/kaggle/discussion/:forumId/:sort?",
  require("./routes/kaggle/discussion"),
);
router.get(
  "/kaggle/competitions/:category?",
  require("./routes/kaggle/competitions"),
);
...
router.get(
  "/ieee/author/:aid/:sortType/:count?",
  require("./routes/ieee/author"),
);
...
router.get(
  ...
  require("./routes/nature/news-and-comment"),
);
...
// science [Sci Journal]
router.get(
  "/sciencemag/current/:journal?",
  require("./routes/sciencemag/current"),
);
...
router.get(
  ...
  require("./routes/dlsite/campaign"),
);
...
router.get(
  "/vscode/marketplace/:type?",
  require("./routes/vscode/marketplace"),
);

// 饭否
router.get(
  "/fanfou/user_timeline/:uid",
  require("./routes/fanfou/user_timeline"),
);
...
router.get(
  ...
  require("./routes/fanfou/public_timeline"),
);
...
// TransferWise
router.get(
  "/transferwise/pair/:source/:target",
  require("./routes/transferwise/pair"),
);

// chocolatey
router.get(
  "/chocolatey/software/:name?",
  require("./routes/chocolatey/software"),
);
...
// 巴哈姆特
router.get(
  "/bahamut/creation/:author/:category?",
  require("./routes/bahamut/creation"),
);
router.get(
  "/bahamut/creation_index/:category?/:subcategory?/:type?",
  require("./routes/bahamut/creation_index"),
);
...
router.get(
  ...
  require("./routes/mastodon/timeline_local"),
);
router.get(
  "/mastodon/remote/:site/:only_media?",
  require("./routes/mastodon/timeline_remote"),
);
router.get(
  "/mastodon/account_id/:site/:account_id/statuses/:only_media?",
  require("./routes/mastodon/account_id"),
);
router.get(
  "/mastodon/acct/:acct/statuses/:only_media?",
  require("./routes/mastodon/acct"),
);
...
router.get(
  ...
  require("./routes/invisionapp/inside-design"),
);
...
// Chrome 网上应用店
router.get(
  "/chrome/webstore/extensions/:id",
  require("./routes/chrome/extensions"),
);
...
router.get(
  ...
  require("./routes/yahoo-news/index"),
);
...
// avgle
router.get(
  "/avgle/videos/:order?/:time?/:top?",
  require("./routes/avgle/videos.js"),
);
router.get(
  "/avgle/search/:keyword/:order?/:time?/:top?",
  require("./routes/avgle/videos.js"),
);
...
router.get(
  "/project-zero-issues",
  require("./routes/project-zero-issues/index"),
);
...
// discuz
router.get(
  "/discuz/:ver([7|x])/:cid([0-9]{2})/:link(.*)",
  require("./routes/discuz/discuz"),
);
...
// China Dialogue 中外对话
router.get(
  "/chinadialogue/topics/:topic",
  require("./routes/chinadialogue/topics"),
);
...
router.get(
  ...
  require("./routes/tencent/wechat/miniprogram/framework"),
); // 基础库更新日志
router.get(
...
router.get(
  ...
  require("./routes/tencent/wechat/miniprogram/devtools"),
); // 开发者工具更新日志
router.get(
  "/weixin/miniprogram/wxcloud/:caty?",
  require("./routes/tencent/wechat/miniprogram/wxcloud"),
); // 云开发更新日志

// 武汉肺炎疫情动态
router.get("/coronavirus/caixin", require("./routes/coronavirus/caixin"));
router.get(
  "/coronavirus/dxy/data/:province?/:city?",
  require("./routes/coronavirus/dxy-data"),
);
...
router.get(
  "/coronavirus/mogov-2019ncov/:lang",
  require("./routes/coronavirus/mogov-2019ncov"),
);
...
router.get(
  ...
  require("./routes/letterboxd/userdiary"),
);
router.get(
  "/letterboxd/user/followingdiary/:username",
  require("./routes/letterboxd/followingdiary"),
);
...
// javlibrary
router.get(
  "/javlibrary/users/:uid/:utype",
  require("./routes/javlibrary/users"),
);
...
router.get(
  ...
  require("./routes/javlibrary/bestreviews"),
);
...
router.get(
  ...
  require("./routes/p-articles/section"),
);
router.get(
  "/p-articles/contributors/:author",
  require("./routes/p-articles/contributors"),
);
...
// 好好住
router.get(
  "/haohaozhu/whole-house/:keyword?",
  require("./routes/haohaozhu/whole-house"),
);
router.get(
  "/haohaozhu/discover/:keyword?",
  require("./routes/haohaozhu/discover"),
);
...
router.get(
  ...
  require("./routes/kuaidi100/index"),
);
router.get(
  "/kuaidi100/company",
  require("./routes/kuaidi100/supported_company"),
);
...
// 魔法纪录
router.get(
  "/magireco/announcements",
  require("./routes/magireco/announcements"),
);
...
router.get(
  ...
  require("./routes/universities/xjtu/international"),
);
...
router.get(
  "/hnust/computer",
  require("./routes/universities/hnust/computer/index"),
);
router.get("/hnust/art", require("./routes/universities/hnust/art/index"));
router.get(
  "/hnust/graduate/:type?",
  require("./routes/universities/hnust/graduate/index"),
);
...
// Hi, DIYgod
router.get(
  "/blogs/diygod/animal-crossing",
  require("./routes/blogs/diygod/animal-crossing"),
);
...
// uniqlo styling book
router.get(
  "/uniqlo/stylingbook/:category?",
  require("./routes/uniqlo/stylingbook"),
);
...
// digic-picture
router.get(
  "/digic-pictures/:menu/:tags?",
  require("./routes/digic-pictures/index"),
);
...
// deeplearning.ai
router.get(
  "/deeplearningai/thebatch",
  require("./routes/deeplearningai/thebatch"),
);
...
router.get(
  ...
  require("./routes/umass/amherst/ipoevents"),
);
router.get(
  "/umass/amherst/ipostories",
  require("./routes/umass/amherst/ipostories"),
);
...
// 网易新闻专栏
router.get(
  "/netease/news/special/:type?",
  require("./routes/netease/news/special"),
);
...
// 漫画堆
router.get(
  "/manhuadui/manhua/:name/:serial?",
  require("./routes/manhuadui/manhua"),
);
...
// Stork
router.get(
  "/stork/keyword/:trackID/:displayKey",
  require("./routes/stork/keyword"),
);
...
// hentai-cosplays
router.get(
  "/hentai-cosplays/:type?/:name?",
  require("./routes/hentai-cosplays/hentai-cosplays"),
);
router.get(
  "/porn-images-xxx/:type?/:name?",
  require("./routes/hentai-cosplays/porn-images-xxx"),
);
...
// 外接大脑
router.get(
  "/waijiedanao/article/:caty",
  require("./routes/waijiedanao/article"),
);
...
router.get(
  ...
  require("./routes/chicagotribune/index"),
);

// Amazfit Watch Faces
router.get(
  "/amazfitwatchfaces/fresh/:model/:type?/:lang?",
  require("./routes/amazfitwatchfaces/fresh"),
);
router.get(
  "/amazfitwatchfaces/updated/:model/:type?/:lang?",
  require("./routes/amazfitwatchfaces/updated"),
);
router.get(
  "/amazfitwatchfaces/top/:model/:type?/:time?/:sortBy?/:lang?",
  require("./routes/amazfitwatchfaces/top"),
);
router.get(
  "/amazfitwatchfaces/search/:model/:keyword?/:sortBy?",
  require("./routes/amazfitwatchfaces/search"),
);
...
// popiask提问箱
router.get(
  "/popiask/:sharecode/:pagesize?",
  require("./routes/popiask/questions"),
);

// AMD
router.get(
  "/amd/graphicsdrivers/:id/:rid?",
  require("./routes/amd/graphicsdrivers"),
);
...
router.get(
  ...
  require("./routes/gelonghui/keyword"),
);
...
// 重庆市两江新区信息公开网
router.get(
  "/gov/chongqing/ljxq/dwgk",
  require("./routes/gov/chongqing/ljxq/dwgk"),
);
router.get(
  "/gov/chongqing/ljxq/zwgk/:caty",
  require("./routes/gov/chongqing/ljxq/zwgk"),
);
...
router.get(
  "/scut/scet/notice",
  require("./routes/universities/scut/scet/notice"),
);
...
// Telecompaper
router.get(
  "/telecompaper/news/:caty/:year?/:country?/:type?/:keyword?",
  require("./routes/telecompaper/news"),
);
...
// soomal
router.get(
  "/soomal/topics/:category/:language?",
  require("./routes/soomal/topics"),
);
...
router.get(
  ...
  require("./routes/edrawsoft/mindmap"),
);
...
router.get(
  ...
  require("./routes/itslaw/judgements"),
);
...
// 华为心声社区
router.get(
  "/huawei/xinsheng/:caty?/:order?/:keyword?",
  require("./routes/huawei/xinsheng/index"),
);
...
// notefolio
router.get(
  "/notefolio/:caty?/:order?/:time?/:query?",
  require("./routes/notefolio/index"),
);

// JavDB
router.get(
  "/javdb/home/:caty?/:sort?/:filter?",
  require("./routes/javdb/home"),
);
router.get(
  "/javdb/search/:keyword?/:filter?",
  require("./routes/javdb/search"),
);
...
router.get(
  "/weforum/report/:lang?/:year?/:platform?",
  require("./routes/weforum/report"),
);
...
router.get(
  ...
  require("./routes/eventernote/actors"),
);
...
// 原神
router.get(
  "/yuanshen/:location?/:category?",
  require("./routes/yuanshen/index"),
);

// World Trade Organization
router.get(
  "/wto/dispute-settlement/:year?",
  require("./routes/wto/dispute-settlement"),
);
