...
const preFetchWrapperRequire = (id) => preFetchWrapper(lazyRouter(() => nativeRequire(id)));
...
// index
router.get('/', lazyRouter(() => nativeRequire('./routes/index')));
...
require = preFetchWrapperRequire;
