          ...
          sem.use(async () => {
            try {
              ...
              if (encryptedState !== undefined) {
                ...
                const articleDetailData = state?.articleDetail?.articleDetailData.data;
                item.title = articleDetailData.widgetTitle ?? articleDetailData.summary;
                item.description = articleDetailData?.widgetContent;
                item.author = articleDetailData?.author;
                item.pubDate = new Date(articleDetailData?.publishTime);
              } else {
                // old
