  ...
  ctx.state.data = {
    ...
    item:
      ...
      list
        .map((item, index) => {
          item = $(index);
          const pretitle = item.find(".pretitle").children()[0].prev
            ? item.find(".pretitle").children()[0].prev.data
            : "";
          const subtitle = item.find(".subtitle").children()[0].next
            ? item.find(".subtitle").children()[0].next.data
            : "";
          return {
