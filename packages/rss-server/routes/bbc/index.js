  ...
  if (site) {
    ...
    case "chinese":
      ...
      if (!channel) {
        ...
        feed = await parser.parseURL(
          `http://www.bbc.co.uk/zhongwen/simp/${channel}/index.xml`,
        );
      }
      break;
    ...
    case "traditionalchinese":
      ...
      if (!channel) {
        ...
        feed = await parser.parseURL(
          `http://www.bbc.co.uk/zhongwen/trad/${channel}/index.xml`,
        );
      }
    ...
    default:
      feed = await parser.parseURL(
        `https://feeds.bbci.co.uk/news/${site.split("-").join("/")}/rss.xml`,
      );
      title = `BBC News ${site}`;
