  ...
  if (!wwwid || !csrf) {
    const indexResponse = await got({
      ...
      headers: {
        // App store
        Referer:
          "https://apps.apple.com/cn/app/%E5%BF%AB%E9%80%92100-%E5%8F%8C11%E5%AF%84%E4%BB%B6%E9%80%80%E8%B4%A7-%E4%B8%8A%E5%BF%AB%E9%80%92100/id458270120",
      },
    });
...
module.exports = {
  ...
  checkCode: async (ctx, number, id, phone) => {
    ...
    if (!company) {
      ...
      if (
        number.indexOf("shunfeng") !== -1 &&
        !isNaN(phone) &&
        String(phone).length !== 4
      ) {
        return {
          status: false,
