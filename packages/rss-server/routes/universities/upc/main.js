...
module.exports = async (ctx) => {
  ...
  // ## 获取列表
  const list = $(
    "div.container > div.main-ny > div.main-ny-cont > div.main-ny-cont-box > div.main-list-box > div.main-list-box-left > ul > li > div.li-right > div.li-right-bt > a",
  ).get();
  // ## 定义输出的item
  const out = await Promise.all(
    ...
    list.map(async (item) => {
      ...
      const detail_content = $(
        "div.container > div.main-ny > div.main-ny-cont > div.main-ny-cont-box > div.main-content-box > form",
      ).html();
      // ### 设置 RSS feed item
      const single = {
        title: title,
