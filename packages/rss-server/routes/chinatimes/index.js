...
module.exports = async (ctx) => {
  ...
  if (!cfg) {
    throw Error(
      'Bad category. See <a href="https://docs.rsshub.app/traditional-media.html#zhong-shi-dian-zi-bao">https://docs.rsshub.app/traditional-media.html#zhong-shi-dian-zi-bao</a>',
    );
  }
  ...
  const list = $("section.article-list ul div.row")
    .map((_, item) => {
      ...
      return {
        ...
        link: a.attr("href"),
        pubDate: new Date(
          right.find("div.meta-info time").attr("datetime") + " GMT+8",
        ).toUTCString(),
        description: desc,
      };
    })
